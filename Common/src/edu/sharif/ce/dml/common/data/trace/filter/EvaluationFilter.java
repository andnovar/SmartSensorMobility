 ...
 * Time: 10:17:59 PM<br>
 */
public class EvaluationFilter extends TraceFilter<EvaluationRecord> {
    ...
    public Class<? extends LoadingHandler<EvaluationRecord>> getLoadingHandlerClass(File file) {
        if (accept(file)) {
            return (EvaluationLoadingHandler.class);
        } else
            return null;
    }
